...
<section class="ygv-voting-list ygv-voting-list--<?php echo esc_attr($layout); ?>" 
         data-list-id="<?php echo esc_attr($voting_list_id); ?>"
...
<?php if ($layout === 'grid'): ?>
    ...
    <div class="ygv-vote-grid">
        ...
        ?>
        <div class="ygv-vote-card <?php echo $rank_class; ?>" 
             data-item-id="<?php echo esc_attr($item['id']); ?>">
            
            <div class="ygv-vote-card__media">
                <span class="ygv-vote-card__rank"><?php echo $item['ranking']; ?></span>
            ...
            <div class="ygv-vote-card__body">
                ...
                <p class="ygv-vote-card__desc"><?php echo esc_html(wp_trim_words($item['short_desc'], 12)); ?></p>
                <?php endif; ?>
                ...
                <div class="ygv-vote-card__buttons">
                    ...
                    <button class="ygv-vote-btn" data-value="<?php echo $i; ?>"><?php echo $i; ?></button>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
    ...
    <div class="ygv-vote-compact">
        ...
        <div class="ygv-compact-row <?php echo $is_top3 ? 'ygv-compact-row--top' . $item['ranking'] : ''; ?>" 
            ...
            <div class="ygv-compact-row__rank">
                ...
                <?php else: ?>
                    <span class="ygv-compact-row__num"><?php echo $item['ranking']; ?></span>
                <?php endif; ?>
            </div>
            ...
            <div class="ygv-compact-row__info">
                ...
                <?php if ($item['short_desc']): ?>
                <p class="ygv-compact-row__desc"><?php echo esc_html(wp_trim_words($item['short_desc'], 15)); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="ygv-compact-row__vote">
                <?php for ($i = 1; $i <= $voting_scale; $i++): ?>
                <button class="ygv-vote-btn ygv-vote-btn--compact" data-value="<?php echo $i; ?>"><?php echo $i; ?></button>
                <?php endfor; ?>
            </div>
        </div>
        <?php endforeach; ?>
    ...
    <div class="ygv-vote-classic">
        ...
        <div class="ygv-classic-card <?php echo $is_top3 ? 'ygv-classic-card--top' . $item['ranking'] : ''; ?>" 
            ...
            <div class="ygv-classic-card__media">
                <span class="ygv-classic-card__rank"><?php echo $item['ranking']; ?></span>
                <img src="<?php echo esc_url($item['image']); ?>" alt="<?php echo esc_attr($item['title']); ?>">
                <?php if ($item['video_url']): ?>
            ...
            <div class="ygv-classic-card__content">
                <div class="ygv-classic-card__header">
                    ...
                    <?php if ($item['short_desc']): ?>
                    <p class="ygv-classic-card__desc"><?php echo wp_kses_post($item['short_desc']); ?></p>
                    <?php endif; ?>
                </div>
                
                <div class="ygv-classic-card__voting">
                    <div class="ygv-classic-card__score">
                        <span class="ygv-classic-card__points" data-item-id="<?php echo esc_attr($item['id']); ?>">0</span>
                        <span class="ygv-classic-card__label">poena</span>
                    </div>
                    
                    <div class="ygv-classic-card__buttons">
                        <?php for ($i = 1; $i <= $voting_scale; $i++): ?>
                        <button class="ygv-vote-btn ygv-vote-btn--classic" data-value="<?php echo $i; ?>"><?php echo $i; ?></button>
                        <?php endfor; ?>
                    </div>
                </div>
            </div>
