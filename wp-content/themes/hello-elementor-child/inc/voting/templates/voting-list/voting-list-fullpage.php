...
if (!empty($voting_items_ids)) {
    ...
    while ($items_query->have_posts()) {
        ...
        $items[] = [
            ...
            'image'       => $pivot_data['custom_image_url'] ?? $default_image ?: get_stylesheet_directory_uri() . '/assets/images/placeholder.jpg',
            'short_desc'  => $pivot_data['short_description'] ?? $default_desc,
