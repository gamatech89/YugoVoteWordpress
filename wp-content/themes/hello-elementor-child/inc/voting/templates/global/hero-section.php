<?php
/**
 * Template part for Homepage Categories Slider (Hero)
 */
    ...
    <div class="swiper cs-home-category-swiper" id="cs-voting-hero-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <?php foreach ($categories as $term) : ?>
                ...
                if (empty($slogan)) {
                    $slogan = strip_tags(term_description($term_id));
                }
                if (empty($slogan)) {
                    $slogan = $term->name; 
                }
                ...
                if (empty($cat_desc)) {
                    $cat_desc = 'Istražite najbolje liste, glasajte za svoje favorite i kreirajte poredak.';
                }

                // 4. FIX: TAČAN BROJ LISTA (Uključujući podkategorije)
                $count_args = [
                    'post_type'      => 'voting_list',
                    'post_status'    => 'publish',
                    'fields'         => 'ids',      // Trebaju nam samo ID-evi radi brzine
                    'posts_per_page' => 1,          // Ne trebaju nam postovi, samo broj
                    'tax_query'      => [
                        [
                            'taxonomy'         => 'voting_list_category',
                            'field'            => 'term_id',
                            'terms'            => $term_id,
                            'include_children' => true, // OVO JE KLJUČNO - broji i podkategorije
                        ]
                    ]
                ];
                $count_query = new WP_Query($count_args);
                $real_count = $count_query->found_posts; // Ukupan broj pronađenih
                ?>
                        ...
                        <div class="cs-home-cat-hero__inner">
                            ...
                            <div class="cs-home-cat-hero__content">
                                ...
                                <h2 class="cs-home-cat-hero__title">
                                    <a href="<?php echo esc_url($term_link); ?>"><?php echo esc_html($slogan); ?></a>
                                </h2>
                                <div class="cs-home-cat-hero__footer">
                                    ...
                                    <div class="cs-home-cat-hero__stats">
                                        <span class="cs-home-cat-hero__count">
                                            <?php echo esc_html($real_count); ?> LISTA
                                        </span>
