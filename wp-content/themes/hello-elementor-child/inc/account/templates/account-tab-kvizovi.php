    ...
    <div class="ygv-card">
        ...
        <?php if (empty($quiz_progress)): ?>
            <div class="ygv-empty-state">
                <div class="ygv-empty-state__icon"><?php ygv_icon_e('brain', 48); ?></div>
                ...
                <a href="<?php echo esc_url(home_url('/kvizovi/')); ?>" class="ygv-btn ygv-btn-primary">
                    ...
                    <?php echo esc_html__('Započni Prvi Kviz', 'hello-elementor-child'); ?>
                </a>
            </div>
        <?php else: ?>
            <div class="ygv-quiz-history-list">
                ...
                <div class="ygv-quiz-history-item">
                    ...
                    <a href="<?php echo esc_url(home_url('/kvizovi/')); ?>" 
                       class="ygv-quiz-history-play"
                       title="<?php echo esc_attr__('Istraži kvizove', 'hello-elementor-child'); ?>">
                        <?php ygv_icon_e('arrow-right', 20); ?>
                    </a>
                </div>
                <?php endforeach; ?>
            </div>
