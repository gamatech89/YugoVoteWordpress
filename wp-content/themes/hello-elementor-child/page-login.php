            ...
            <div class="ygv-auth-branding">
                <div class="ygv-auth-branding__content">
                    <div class="ygv-auth-branding__logo">
                        <img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/mascot.svg'); ?>"
                            alt="YugoVote Mascot" class="ygv-auth-mascot">
                    </div>
                ...
                <div class="ygv-auth-form-container">
                    <div class="ygv-auth-form-card">
                        ...
                        <form id="ygv-login-form" class="ygv-auth-form" method="post"
                            ...
                            <input type="hidden" name="yugo_login_nonce"
                                value="<?php echo wp_create_nonce('yugo_login_nonce'); ?>">
                            <div class="ygv-auth-field">
                                ...
                                <input type="text" name="log" id="user_login"
                                    value="<?php echo esc_attr($attempted_username); ?>"
                            ...
                            <div class="ygv-auth-field">
                                ...
                                <div class="ygv-auth-password-wrapper">
                                    <input type="password" name="pwd" id="user_pass" placeholder="Unesite lozinku"
                                        required>
                            ...
                            <div class="ygv-auth-options">
                                ...
                                <a href="<?php echo esc_url(wp_lostpassword_url()); ?>"
                                    class="ygv-auth-forgot">Zaboravljena lozinka?</a>
                            </div>

                            <input type="hidden" name="redirect_to"
                                value="<?php echo esc_url(home_url('/' . CUSTOM_ACCOUNT_PAGE_SLUG . '/')); ?>">
                        ...
                        <div class="ygv-auth-footer">
                            <p>Nemate nalog? <a
                                    href="<?php echo esc_url(home_url('/' . CUSTOM_REGISTER_PAGE_SLUG . '/')); ?>">Registrujte
                                    se</a></p>
                        </div>
                    </div>
                </div>
